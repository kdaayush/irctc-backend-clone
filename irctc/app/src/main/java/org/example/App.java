...
public class App {
    ...
    public static <UserBookingService> void main(String[] args) throws IOException {
        ...
        org.example.Train trainSelectedForBooking = null;
        while(option!=7){
